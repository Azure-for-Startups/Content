...
###Azure Fv2 VM 
[**Enjoy the fastest VMs in the public cloud with the new Azure Fv2 VM for compute-intensive workloads**](https://azure.microsoft.com/en-us/blog/fv2-vms-are-now-available-the-fastest-vms-on-azure/?v=17.42n)Your solution needs massive amounts of compute to solve your customers’ complex problems, like financial modeling, manufacturing and scientific research, genomics, and deep learning. Azure can help you in harnessing the power of supercomputing capabilities to handle these world-changing workloads in an agile and cost-effective way. Microsoft has announced general availability of its new Fv2 VM family, which uses the fastest Intel Xeon Scalable processor, code-named Skylake, in the public cloud. These VM sizes are hyper-threaded and run on the Intel Xeon Platinum 8168 processor, which features a base core frequency of 2.7 GHz and a maximum single-core turbo frequency of 3.7 GHz. This will provide as much as a 200% performance boost to vector processing workloads on both single- and double-precision floating point operations. The Fv2 VMs will be available in seven sizes, with the largest size featuring 72 vCPUs and 144 GiB of RAM. These sizes will support Azure premium storage disks by default and accelerated networking capabilities for the highest throughput. This makes Azure the best place for computationally intensive workloads, providing the newest and best tools for the job.


###Azure Distributed Data Engineering Toolkit
[**Experiment by using the Azure Batch infrastructure to provision on-demand Spark clusters **](https://azure.microsoft.com/en-au/blog/on-demand-spark-clusters-on-docker/)Your big data solution takes advantage of the power of Apache Spark, but spinning up a Spark cluster on-demand can be complicated and slow. To solve this problem Microsoft has announced the beta release of the Azure Distributed Data Engineering Toolkit, an open-source Python CLI tool that allows you to provision on-demand Spark clusters and submit Spark jobs directly from your CLI. Microsoft designed this toolkit to extend the native Spark experience, allowing you to provision clusters and giving you the full end-to-end experience of running Spark at scale. And this toolkit inherits the fast provision time of Azure Batch—it takes only 3-5 minutes to provision your Spark cluster. The toolkit also lets you bring your own Docker image, making setup easy and reproducible. The toolkit is free to use—you pay only for the cores you consume. Because it’s built on Azure Batch, it can provision low-priority VMs for experimentation, testing, and other low-priority work.
...
### Azure App Service
[**Use nearForm Migration and Developer Support Services to confidently move to the cloud with Node.js*](https://azure.microsoft.com/en-us/blog/microsoft-azure-allies-with-nearform-for-node-js-developer-migration-and-support-services/?v=17.42n) YWith the announcement of Azure App Service on Linux and Azure Web App for Containers, combined with support for Node.js across Azure Functions, Microsoft continues its commitment to developers who use Node.js to build and deploy on Azure. Now, nearForm and Microsoft have announced a new alliance to help you migrate Node.js apps to Azure , and provide enterprise-grade support. By partnering with nearForm, Microsoft brings its multi-year expertise in architecting, designing, and supporting Node.js apps to developers as they adopt Azure and build on the Microsoft cloud. nearForm, with its proficiency and experience in architecting and developing full-stack JavaScript solutions, can now help businesses like yours migrate to Azure. You can generate a prototype of new business ideas with nearForm's Solutions teams and then work with them to turn the prototype into a production system. nearForm's Developer Support service ensures that your teams have direct access to the most knowledgeable Node.js developers in the industry, including Node.js Core contributors. This level of expertise can guide you step-by-step through the process.
